...
public class JWTGenerator {
    ...
    private final long jwtExpiryTtl;

    private final SecretKey key;

    /*
    Note:-
    Option 1: Using Keys.hmacShaKeyFor (recommended for fixed-length secrets)
    ...
    */
    public JWTGenerator(@Value("${jwt-expiry-ttl}") long jwtExpiryTtl,
                        @Value("${jwt-secret}") String secret) {
        this.jwtExpiryTtl = jwtExpiryTtl;
